...
with tf.Session() as sess:
    ...
    train_writer = tf.summary.FileWriter('/mnt/hgfs/WorkSpace/data/MNIST/logs/train', sess.graph)
    test_writer = tf.summary.FileWriter('/mnt/hgfs/WorkSpace/data/MNIST/logs/test', sess.graph)
    for i in range(11):
        # 训练模型

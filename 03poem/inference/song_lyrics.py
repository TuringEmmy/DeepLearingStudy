...
tf.app.flags.DEFINE_string('file_path', os.path.abspath('/mnt/hgfs/WorkSpace/data/poem/data/周杰伦歌词大全.txt'), 'file path of lyrics.')
tf.app.flags.DEFINE_string('checkpoints_dir', os.path.abspath('/mnt/hgfs/WorkSpace/data/poem/data/checkpoints/lyrics'), 'checkpoints save path.')

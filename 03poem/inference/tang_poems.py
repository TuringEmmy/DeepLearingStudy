...
tf.app.flags.DEFINE_string('checkpoints_dir', os.path.abspath('/mnt/hgfs/WorkSpace/data/poem/checkpoints/poems/'), 'checkpoints save path.')
tf.app.flags.DEFINE_string('file_path', os.path.abspath('/mnt/hgfs/WorkSpace/data/poem/data/poems.txt'), 'file name of poems.')
